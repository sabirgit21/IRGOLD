...
// ---    Thu Feb 04 16:05:59 PKT 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblEmpKinImpl extends EntityImpl {
    /**
    ...
    public static final int MOB = AttributesEnum.Mob.index();
    ...
    /**
     * Gets the attribute value for Mob, using the alias name Mob.
     * @return the value of Mob
     */
    public String getMob() {
        return (String) getAttributeInternal(MOB);
    }

    /**
     * Sets <code>value</code> as the attribute value for Mob.
     * @param value value to set the Mob
     */
    public void setMob(String value) {
        setAttributeInternal(MOB, value);
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.ERP.EO.TblEmpKin");
    }
