...
// ---    Mon Sep 07 11:33:18 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TblStdDiscPolMasterImpl extends EntityImpl {
    /**
    ...
    public static final int STDORDERNO = AttributesEnum.StdOrderNo.index();
    ...
    public static final int TBLSTDDISCPOLDETAIL = AttributesEnum.TblStdDiscPolDetail.index();
    ...
    /**
     * Gets the attribute value for StdOrderNo, using the alias name StdOrderNo.
     * @return the value of StdOrderNo
     */
    public BigDecimal getStdOrderNo() {
        return (BigDecimal) getAttributeInternal(STDORDERNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for StdOrderNo.
     * @param value value to set the StdOrderNo
     */
    public void setStdOrderNo(BigDecimal value) {
        setAttributeInternal(STDORDERNO, value);
    }
     ...
     */
    public RowIterator getTblStdDiscPolDetail() {
