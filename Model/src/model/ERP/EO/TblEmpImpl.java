...
public class TblEmpImpl extends EntityImpl {
    ...
    public static final int TBLPROMOTION = AttributesEnum.TblPromotion.index();
    public static final int TBLTRANSFER = AttributesEnum.TblTransfer.index();
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getTblPromotion() {
        return (RowIterator) getAttributeInternal(TBLPROMOTION);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getTblTransfer() {
        return (RowIterator) getAttributeInternal(TBLTRANSFER);
    }
